...
const Page4 = () => {
  ...
  return (
    <div>
      ...
      <div className=" py-4">
                    <div className="q1  ">
                    <p className="text-2xl font-semibold">13. My child feels that I treat him/her unfairly.</p>
                ...
                <div className="q2  ">
                    <p className="text-2xl font-semibold">14. . My child asks for my help when he/she really does not need help.</p>
                    <div className="options text-xl flex justify-between flex-wrap">
                ...
                <div className="q3  ">
                    <p className="text-2xl font-semibold">15. It is easy to be in tune with what my child is feeling.</p>
                    <div className="options text-xl flex justify-between flex-wrap">
                ...
                <div className="q4 ">
                    <p className="text-2xl font-semibold">16. I've noticed my child copying my behavior or ways of doing things. </p>
                    <div className="options text-xl flex justify-between flex-wrap">
